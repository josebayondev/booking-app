  ...
  return (
    <div className="flex flex-col gap-24">
      <section className="mx-auto max-w-3xl pt-20 text-center">
        <p className="mx-auto inline-flex items-center gap-2 rounded-full bg-stone-900/5 px-3 py-1 text-xs font-medium tracking-wide text-stone-600 uppercase">
        ...
        <p className="mx-auto mt-6 inline-flex items-center gap-2 rounded-full bg-surface px-3 py-1.5 text-xs text-stone-500">
